...
--Dye ajouté par Jat
minetest.register_craft({	output = 'node "madblocks:dye_white" 4',	recipe = {
		{'','',''},
		{'default:clay_lump','',''},
		{'','',''},
	}})
minetest.register_craft({	output = 'node "madblocks:dye_grey" 2',	recipe = {
		{'','',''},
		{'','madblocks:dye_black',''},
		{'','madblocks:dye_white',''},
	}})
minetest.register_craft({	output = 'node "madblocks:dye_orange" 2',	recipe = {
		{'','',''},
		{'','madblocks:dye_red',''},
		{'','madblocks:dye_yellow',''},
	}})
minetest.register_craft({	output = 'node "madblocks:dye_pink" 2',	recipe = {
		{'','',''},
